...
- 8 random batches x 2 ciphertexts: **0 decryption failures**
- error magnitudes: max 4,065,698 = 0.1212 of q/4; mean 1,630,650
- extended-basis GS norms: max 666 (sigma1 = 4000, margin 6.01x)
- Lemma-31 selection produced an exact Lambda^perp basis in 0/8 batches (sublattice otherwise - documented deviation, AUDIT.md S3)
- wall time 105s
...
- 3 random (batch, act) threshold pre-decryptions: **0 failures**
- B_th = 1.5e+06 vs q/2 = 1.34e+08
- 3 threshold GPV sign/verify cycles: **0 failures**
